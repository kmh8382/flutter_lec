...
void info2({String? name, int? age}) {      // void info2({String name = "", int age = 0})
  print("name : ${name}, age : ${age}");
}

// 8. 생략 가능한 optional parameter
// 생략 기능한 parameter를 []로 묶습니다.
// null 처리를 위해서 디폴트 값을 자주 사용합니다.
void info3(String name, [int age = 30]) {   // [int? age] 또는 [int age = 20]
  print("name : ${name}, age : ${age}");
}
